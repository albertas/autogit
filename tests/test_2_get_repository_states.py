...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://managedgit.com/mygroup/mynamespace/myreponame", "myreponame", "mynamespace", "mygroup", "managedgit.com"),
        ("https://managedgit.com/mygroup/mynamespace/myreponame.git", "myreponame", "mynamespace", "mygroup", "managedgit.com"),
    ]
)
def test_get_repository_state(repo_url, expected_name, expected_owner, expected_group, expected_domain):
